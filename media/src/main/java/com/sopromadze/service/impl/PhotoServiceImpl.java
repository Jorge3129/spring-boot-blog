...
import com.sopromadze.model.Photo;
...
import com.sopromadze.repository.PhotoRepository;
...
public class PhotoServiceImpl implements PhotoService {
	...
	public PhotoResponse updatePhoto(Long id, PhotoRequest photoRequest, UserPrincipal currentUser) {
		...
		if (photo.getAlbum().getUserId().equals(currentUser.getId())
	...
	public PagedResponse<PhotoResponse> getAllPhotosByAlbum(Long albumId, int page, int size) {
		...
		return new PagedResponse<>(
				photoResponses, photos.getNumber(), photos.getSize(), photos.getTotalElements(),
